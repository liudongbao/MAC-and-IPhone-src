...
-(id) init
{
	if ((self = [super init]))
	{
		...
		CCLabelTTF* label = [CCLabelTTF labelWithString:@"Touch Screen to Continue" fontName:@"AmericanTypewriter-Bold" fontSize:20];
		...
		CCLabelTTF* labelAligned = [CCLabelTTF labelWithString:@"I'm topright aligned!" fontName:@"HiraKakuProN-W3" fontSize:20];
