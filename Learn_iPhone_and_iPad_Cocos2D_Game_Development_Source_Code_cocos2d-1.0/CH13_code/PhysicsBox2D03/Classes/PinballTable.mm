...
-(void) update:(ccTime)delta
{
	...
	/* Drawing dynamic bodies is disabled, it will use the BodyNode class which isn't defined yet. 
	 Please refer to the following versions of this project.
	...
	for (b2Body* body = world->GetBodyList(); body != nil; body = body->GetNext())
	{
		...
		if (bodyNode != NULL && bodyNode.sprite != nil)
		{
			...
			bodyNode.sprite.rotation = CC_RADIANS_TO_DEGREES(angle) * -1;
		}
	}
	 */
}
