...
#import "Game3dAppDelegate.h"
#import "Game3dViewController.h"

//include the state classes we might switch to
#import "gsMainMenu.h"
#import "Options.h" //for setting up default options on first start

#define LOOP_TIMER_MINIMUM 0.033f
#define IPHONE_HEIGHT 480
#define IPHONE_WIDTH 320

@implementation Game3dAppDelegate
...
- (void)applicationDidFinishLaunching:(UIApplication *)application {    
	...
	if([g_ResManager getUserData:@"calibrate"] == nil){
