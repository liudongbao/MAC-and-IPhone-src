...
//	b2Vec2 v = -5.0f * p;  
	...
	b2Vec2 p(RandomFloat(-5.0f, 5.0f), 3.0f);
	b2Vec2 v = -2.0f * p;  
...
//		glEnd();
        ccDrawPoint(ccp(m_bombSpawnPoint.x, m_bombSpawnPoint.y));
      glPointSize(1.0f);
//		
...
//		glEnd();
    ...
    ccDrawLine(ccp(m_bombSpawnPoint.x, m_bombSpawnPoint.y), ccp(m_mouseWorld.x, m_mouseWorld.y));
