...
- (id)initWithField:(CGRect)field topPaddle:(Paddle*)topP bottomPaddle:(Paddle*)bottomP {
...
- (void)bounceBallOffPaddle:(Paddle*)paddle {
  // Figure out which way it's going to go depending upon which paddle we are bouncing off
